...
$(document).ready(function(){
  ...
  $(".dark-btn").click(function(){
    ...
    $("body, #navbar, .about__mid, #services, .ser-layout2__items .ser-l1-items__content a, .ser-layout2__body--layout, .services-button, .article, .abt-l2-sub__content--sect1 .abt-l2-sub__text a, .abt-sect4__text a, .about__sect5, .services__sect2").toggleClass("dark-theme");
