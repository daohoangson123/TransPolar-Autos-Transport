...
closeDialog.onclick = function () {
    ...
    let resetTransform = function () {
        // reset lại display và translate
...
if (closeVideoDialog) {
    closeVideoDialog.onclick = function () {
        ...
        // reset video khi đóng video
        var resetVideo = document.getElementById('video-content');
        ...
        var iframes = resetVideo.getElementsByTagName('iframe');
        if (iframes != null) {
...
$(document).ready(function () {
    ...
    $('.dark-btn').click(function () {
        ...
        $(
            'body, #navbar, .dropdown-content a, #search, #search-hidden, .search__div, .about-mid, #services, .ser-bot, .ser-layout2__items .ser-l1-items__content a, .ser-layout2__body--layout, .services-button, .article, .abt-l2-sub__content--sect1 .abt-l2-sub__text a, .abt-sect4__text a, .about__sect5, .services__sect2',
